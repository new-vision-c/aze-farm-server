export const fr = {
  ...
  auth: {
    ...
    already_verified: 'Votre compte est déjà vérifié. Vous pouvez vous connecter directement.',
    already_verified_use_login:
      'Votre compte est déjà vérifié. Veuillez utiliser la page de connexion normale.',
  ...
  // Messages pour les paiements
  payments: {
    initialized: 'Paiement initialisé avec succès',
    init_error: "Erreur lors de l'initialisation du paiement",
    verified: 'Paiement vérifié avec succès',
    verify_error: 'Erreur lors de la vérification du paiement',
    cancelled: 'Paiement annulé avec succès',
    cancel_error: "Erreur lors de l'annulation du paiement",
    status_retrieved: 'Statut du paiement récupéré avec succès',
    status_error: 'Erreur lors de la récupération du statut',
    callback_processed: 'Callback traité avec succès',
    callback_error: 'Erreur lors du traitement du callback',
    transaction_not_found: 'Transaction non trouvée',
    invalid_amount: 'Le montant doit être supérieur à 0',
    invalid_phone: 'Les informations de paiement mobile sont requises',
    ...
    demo_mode: 'Mode démo - Paiement auto-validé',
    phone_invalid_for_provider: 'Numéro de téléphone invalide pour ce provider',
    payment_init_error: "Erreur lors de l'initiation du paiement",
  },

  // Messages pour les commandes
  orders: {
    created: 'Commandes créées et paiements initiés avec succès',
    retrieved: 'Commandes récupérées avec succès',
    retrieved_single: 'Commande récupérée avec succès',
    ...
    already_paid: 'Commande déjà payée - contactez le support pour annulation',
    farm_orders_retrieved: 'Commandes de la ferme récupérées avec succès',
    status_updated: 'Statut de la commande mis à jour avec succès',
    tracking_retrieved: 'Tracking récupéré avec succès',
    confirmation_generated: 'Token de confirmation généré avec succès',
    delivery_confirmed: 'Livraison confirmée avec succès',
    already_delivered: 'Commande déjà livrée',
    invalid_token: 'Token ou QR code invalide',
    cart_empty: 'Panier vide',
    stock_insufficient: 'Stock insuffisant pour {product} (disponible: {stock})',
